...
'@
            ...
            It "Passes the -ServerName parameter to Invoke-JiraMethod if specified" {
                Get-JiraIssueCreateMetadata -Project 10003 -IssueType 2 -ServerName 'testServer'
            ...
            It "Uses ConvertTo-JiraCreateMetaField to output CreateMetaField objects if JIRA returns data" {
                ...
                Mock ConvertTo-JiraCreateMetaField {}

                { Get-JiraIssueCreateMetadata -Project 10003 -IssueType 2 } | Should Not Throw
                Assert-MockCalled -CommandName Invoke-JiraMethod -Exactly -Times 1 -Scope It -ParameterFilter {$Method -eq 'Get' -and $URI -like '*/rest/api/*/issue/createmeta?projectIds=10003&issuetypeIds=2&expand=projects.issuetypes.fields'}
                ...
                Assert-MockCalled -CommandName ConvertTo-JiraCreateMetaField -Exactly -Times 1 -Scope It
            }
        }
    }
}
